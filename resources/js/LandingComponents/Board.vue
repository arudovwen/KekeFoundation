<template>
  <div class="board flex flex-col md:flex-row md:w-10/12 mx-auto relative z-10 md:-mt-20  rounded">
      <div class="basis-1/2 p-7 bg-red-400 text-left">
      <span class="text-xl md:text-3xl">Served Over</span>  <br>
